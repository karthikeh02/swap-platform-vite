...
export default function SwapPage() {
  ...
  return (
    <div className="relative min-h-[calc(100vh-72px)]">
      {/* Background */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-purple-100/50 rounded-full blur-[120px] pointer-events-none" />
      ...
      <main className="max-w-[440px] mx-auto px-4 py-14 md:py-20 relative z-10">
        {/* Swap Card */}
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
          className="p-6 md:p-8 rounded-3xl bg-white border border-slate-200 shadow-xl shadow-purple-900/5"
        >
          <h2 className="text-2xl font-extrabold text-center mb-7 text-slate-900">Swap</h2>
        ...
        <motion.div
          ...
          className="mt-5 p-5 rounded-2xl bg-white border border-slate-200 shadow-sm text-center"
        >
          <div className="flex items-center justify-center gap-3">
            ...
            <div>
              <p className="text-slate-900 font-bold">Contact Us</p>
              <a
        ...
        <div className="mt-6 text-center">
          <button
            ...
            className="text-slate-400 hover:text-purple-600 text-sm flex items-center gap-2 mx-auto transition-colors"
          >
            <RefreshCw size={14} />
            Reload tokens
          </button>
